...
import { DocumentationCopilotPanelComponent } from './components/documentation-copilot-panel/documentation-copilot-panel.component';
import {GenericOpenAIChatService, GenericDocumentationCopilotService} from "diagnostic-data";


@NgModule({
    declarations: [
        DocumentationCopilotPanelComponent
    ],
    imports: [
        CommonModule,
        FormsModule,
    ...
    providers: [
        {provide: GenericOpenAIChatService, useExisting: GenericDocumentationCopilotService}
    ]
})
export class DocumentationCopilotModule {
}
